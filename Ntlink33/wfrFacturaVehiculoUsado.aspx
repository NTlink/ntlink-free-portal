<%@ Page Title="VEhiculo Usado" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaVehiculoUsado.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="Ntlink33.wfrFacturaVehiculoUsado"  EnableEventValidation="false" %>
    ...
    <%--------------- Sección - Addenda---------------%>
        ...
        <div id="Acordion6" class="panel-collapse collapse">
          <div class="panel-body">
               ...
               <ContentTemplate>
                   ...
                   <div class = "col-lg-3">
                        <asp:Label ID="Label14" runat="server" Text="MontoAdquisicion"></asp:Label>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red"
            ...
            ValidationGroup="CrearFactura" />                      
                    ...
                    <div class = "col-lg-3">
                        <asp:Label ID="Label38" runat="server" Text="MontoEnajenacion"></asp:Label>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
            ...
            ValidationExpression="\d+\.?\d?\d?\d?\d?\d?\d?"   ValidationGroup="CrearFactura" />
                     
                    </div>             
             <div class = "col-lg-3">
                        <asp:Label ID="Label39" runat="server" Text="ClaveVehicular"></asp:Label>
            ...
            ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
                 ...
                 <div class = "row form-group " > 
                      <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label40" runat="server" Text="Marca"></asp:Label>
            ...
            ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
              ...
              <div class = "col-lg-3">
                        <asp:Label ID="Label41" runat="server" Text="Tipo"></asp:Label>
            ...
            ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
                        ...
                        <div class = "col-lg-3">
                        <asp:Label ID="Label42" runat="server" Text="Modelo"></asp:Label>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
            ...
            <div class = "row form-group " > 
                  <div class = "col-lg-1"></div>
                  <div class = "col-lg-3">
                        <asp:Label ID="Label48" runat="server" Text="Numero"></asp:Label>
                  ...
                  <div class = "col-lg-3">
                        <asp:Label ID="Label49" runat="server" Text="Fecha"></asp:Label>
            ...
            ValidationGroup="AgregarAduanaVU"></asp:RequiredFieldValidator>
                         ...
                         <div class = "col-lg-3">
                        <asp:Label ID="Label47" runat="server" Text="Aduana"></asp:Label>
                 ...
                 <div class = "col-lg-3">
                         ...
                         <asp:LinkButton ID="btnAgregarPilgrims" CssClass="btn btn-default" 
                             OnClick="btnAgregarPilgrims_Click"  ValidationGroup="AgregarAduanaVU"
                              Text="Concepto" runat="server" >
  ...
  <div  class="row mt-4">
                <div class = "col-12"> 
                  <div class="table-responsive  border border-dark">
                     ...
                     <asp:GridView ID="gvPilgrims" class="table table-bordered table-hover table-striped grdViewTable" 
                         runat="server" AutoGenerateColumns="false"  BackColor="White" AlternatingRowStyle-HorizontalAlign="Left" 
                         OnRowCommand="gvPilgrims_RowCommand" Width="100%" RowStyle-Height="5"   BorderWidth="0px"
                         OnRowDataBound="gvCfdiRelacionado_RowDataBound">
                         <RowStyle  Height="10" Font-Size="14px"  cssclass="RowStyle" />
                         <FooterStyle  Font-Bold="True"  />
                         <PagerStyle  Height="5"  />
           ...
           <%--  <asp:ButtonField Text="Eliminar" CommandName="EliminarPilgrims" />--%>
                     ...
                     <Triggers>
                                       <asp:AsyncPostBackTrigger  ControlID="btnAgregarPilgrims"  EventName="Click" />
