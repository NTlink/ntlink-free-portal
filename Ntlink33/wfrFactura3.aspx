<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFactura3.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="GafLookPaid.wfrFactura3"  EnableEventValidation="false" %>
        ...
        <div class="col-lg-6">
         <asp:Label  class="control-label" ID="lbEmpresa" runat="server" Text="Empresa"></asp:Label>
          <asp:DropDownList ID="ddlEmpresa"  runat="server" Width="100%" AutoPostBack="True"
              ...
              CssClass ="drpCountryRGV" data-live-search-style="begins" 
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
       ...
       <div class = "row"> <%--Clave Unidad/No. Identificación--%>
              ...
              <div class = "row"> 
                  ...
                  <div class="btn-toolbar pull-right">
                       ...
                       <asp:LinkButton ID="btnAgregar" CssClass="btn btn-default mr-2" 
                             ...
                             runat="server" ><span class="glyphicon glyphicon-plus"></span> Agregar 
                         </asp:LinkButton>
                      ...
                      <button type="button"
                          ...
                          class="btn btn-default mr-2" > <span class="glyphicon glyphicon-search"></span> BuscadorSAT 
                     </button>
        ...
        <div class = "card mt-2">
            <div class = "card-header">
                <asp:CheckBox ID="cbImpuestos" runat="server" AutoPostBack="True" 
                    OnCheckedChanged="cbImpuestos_CheckedChanged"   Text="Impuestos" />
            </div>
            <div class ="card-body" id="DivImpuestos" runat="server" >
                ...
                <div class = "row">
                    ...
                    <div class = "form-group col-lg-4 ">
                        ...
                        <asp:DropDownList ID="ddlTasaOCuota" runat="server" 
                           CssClass ="btn btn-default dropdown-toggle optionAlinear"  Width="100%" BackColor="White"
