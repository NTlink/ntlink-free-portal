<%@ Page Title="Firmas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaFirmas.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="Ntlink33.wfrFacturaFirmas"  EnableEventValidation="false" %>
     ...
     <div class="panel panel-default" style="width:100%">
       ...
       <div class = "row">
           <div class = "from-inline col-lg-2">
               <asp:Label ID="Label14" class="control-label" runat="server" Text=" Vo. Bo."></asp:Label>
            </div>
        <div class = "form-group col-lg-3">
               <asp:Label ID="Label38" class="control-label" runat="server" Text="Nombre"></asp:Label>
               <asp:TextBox runat="server" ID="txtVoBoNombre" CssClass="form-control"></asp:TextBox>
                        
            </div>
           <div class = "form-group col-lg-3">
               <asp:Label ID="Label39" class="control-label" runat="server" Text="Puesto"></asp:Label>
              <asp:TextBox runat="server" ID="txtVoBoPuesto" CssClass="form-control"></asp:TextBox>
                                     
            </div>
            <div class = "form-group col-lg-3">
               <asp:Label ID="Label40" class="control-label" runat="server" Text="Area"></asp:Label>
          ...
          <div class = "row">
           <div class = "from-inline col-lg-2">
               <asp:Label ID="Label41" class="control-label" runat="server" Text=" Recibí"></asp:Label>
            </div>
        <div class = "form-group col-lg-3">
               <asp:Label ID="Label42" class="control-label" runat="server" Text="Nombre"></asp:Label>
                <asp:TextBox runat="server" ID="txtRecibiNombre" CssClass="form-control"></asp:TextBox>         
            </div>
           <div class = "form-group col-lg-3">
               <asp:Label ID="Label43" class="control-label" runat="server" Text="Puesto"></asp:Label>
                <asp:TextBox runat="server" ID="txtRecibiPuesto" CssClass="form-control"></asp:TextBox>
                                                 
            </div>
            <div class = "form-group col-lg-3">
               <asp:Label ID="Label44" class="control-label" runat="server" Text="Area"></asp:Label>
               <asp:TextBox runat="server" ID="txtRecibiArea" CssClass="form-control"></asp:TextBox>
                ...
                <div class = "row">
           <div class = "from-inline col-lg-2">
               <asp:Label ID="Label45" class="control-label" runat="server" Text=" Autorizó"></asp:Label>
            </div>
        <div class = "form-group col-lg-3">
               <asp:Label ID="Label46" class="control-label" runat="server" Text="Nombre"></asp:Label>
             <asp:TextBox runat="server" ID="txtAutorizoNombre" CssClass="form-control"></asp:TextBox>
                </div>
           <div class = "form-group col-lg-3">
               <asp:Label ID="Label47" class="control-label" runat="server" Text="Puesto"></asp:Label>
                 <asp:TextBox runat="server" ID="txtAutorizoPuesto" CssClass="form-control"></asp:TextBox>
                                                            
            </div>
            <div class = "form-group col-lg-3">
               <asp:Label ID="Label48" class="control-label" runat="server" Text="Area"></asp:Label>
