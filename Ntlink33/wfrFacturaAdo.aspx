<%@ Page Title="CFDI 3.3" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaAdo.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="Ntlink33.wfrFacturaAdo"  EnableEventValidation="false" %>
        ...
        <div id="Acordion7" class="panel-collapse collapse">
          <div class="panel-body">
              <div class = "row form-group " > 
                   ...
                   <div class = "col-lg-12">
                      <h4> <asp:Label ID="Label14" runat="server" Text="Datos ado"></asp:Label> </h4>
                   </div>
                ...
                <div class = "row form-group " > 
                 <div class = "col-lg-3"></div>
                   ...
                   <div class = "col-lg-3">
                   <asp:Label ID="Label38" runat="server" Text="Valor"></asp:Label> 
                    <asp:TextBox ID="txtValor" runat="server" CssClass="form-control" ></asp:TextBox>
                   </div>
                     <div class = "col-lg-3">
                   <asp:Label ID="Label39" runat="server" Text="Proveedor"></asp:Label> 
