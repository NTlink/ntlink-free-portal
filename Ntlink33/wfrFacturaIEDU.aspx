<%@ Page Title="Instituciones Educativas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaIEDU.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="Ntlink33.wfrFacturaIEDU"  EnableEventValidation="false" %>
         ...
         --%>               <asp:Label ID="Label33" runat="server" ForeColor="Red" Text="* "></asp:Label>
            ...
            TargetControlID="txtDescuento" FilterType="Custom, Numbers"   ValidChars="." Enabled="True" />
              ...
              <div class = "row"> 
                    ...
                    <div class = "row"> 
                      <div class = "col-12">
                        <h4>  <asp:Label ID="Label14" class="control-label" runat="server" Text="Datos del estudiante">
                  ...
                  <div class="row">
                     <div class = "form-group col-lg-3">
                        <asp:Label ID="Label38" class="control-label" runat="server" Text="NombreAlumno"></asp:Label>
                        <asp:TextBox ID="txtNombreAlumno" runat="server" CssClass="form-control" ></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="txtNombreAlumnoR" runat="server" 
                       ...
                       <div class = "form-group col-lg-3">
                        <asp:Label ID="Label39" class="control-label" runat="server" Text="CURP"></asp:Label>
                              <asp:TextBox ID="txtcurp" runat="server" CssClass="form-control" MaxLength="18"></asp:TextBox>
                        ...
                        <div class = "form-group col-lg-3">
                        <asp:Label ID="Label40" class="control-label" runat="server" Text="RFCPago"></asp:Label>
                    ...
                    <div class="row">
                     <div class = "form-group col-lg-3">
                        <asp:Label ID="Label41" class="control-label" runat="server" Text="Nivel Educativo"></asp:Label>
                          <asp:DropDownList ID="ddlniveleducativo" runat="server" 
                               CssClass ="btn btn-default dropdown-toggle optionAlinear"  BackColor="White" Width="100%"
                              >
                       ...
                       <div class = "form-group col-lg-3">
                        <asp:Label ID="Label42" class="control-label" runat="server" Text="autRVOE"></asp:Label>
                                  <asp:TextBox ID="txtautRVOE" runat="server" CssClass="form-control" ></asp:TextBox>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class = "row"> 
             <div class="col-12" >
                  <asp:Label  class="control-label" ID="Label43" runat="server" Text="nombreEstudiante"></asp:Label>
                       <asp:TextBox ID="txtnombreE" runat="server" CssClass="form-control"/>
                    </div>
             </div>
              <div class = "row "> 
             <div class="col-12" >
                 <asp:Label  class="control-label" ID="Label44" runat="server" Text="CURP"></asp:Label>
                    <asp:TextBox ID="txtcurpe" runat="server" CssClass="form-control"/>
                    </div>
             </div>
               <div class = "row "> 
             <div class="col-12" >
                 <asp:Label  class="control-label" ID="Label45" runat="server" Text="RFC Estudiante"></asp:Label>
                   <asp:TextBox ID="txtrfce" runat="server" CssClass="form-control"/>
                    </div>
             </div>
            <div class = "row "> 
             <div class="col-12" >
                 <asp:Label  class="control-label" ID="Label46" runat="server" Text="Nivel Educativo"></asp:Label>
             ...
             <div class="col-12" >
                 <asp:Label  class="control-label" ID="Label47" runat="server" Text="autRVOE"></asp:Label>
